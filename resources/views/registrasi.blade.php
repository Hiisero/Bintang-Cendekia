        ...
        <div class="daftar-wrapper">
            ...
            <form action="{{ route('registrasi.submit') }}" method="post" class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <label>
                        <input type="radio" name="jenis_pendaftar" value="Pendaftar Dalam Kota" required> Pendaftar Dalam Kota
                    </label>
                    <label>
                        <input type="radio" name="jenis_pendaftar" value="Pendaftar Luar Kota"> Pendaftar Luar Kota
                    </label>
                </div>
                <div class="form-group">
                    <p class="mb-0">Asal Sekolah</p>
                    <label>
                        <input type="radio" name="asal_sekolah" value="Sekolah Dalam Kota" required> Sekolah Dalam Kota
                    </label>
                    <label>
                ...
                <div class="mb-4">
                    <button type="submit" class="btn w-100 space-between" style="background-color: #234df0; color: #fff; border: none">
                        Registrasi
                    </button>
                </div>
